            ...
            <div>
              <div className="lg:w-[770px] ">
                <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                  We help patients live a healthier, longer life.
                </h1>
                <p className="text_para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Obcaecati molestiae vitae nulla itaque esse assumenda
                  similique atque animi? Nam voluptas numquam quibusdam, eum
                  inventore fugit explicabo architecto quasi incidunt iure?
                </p>
        ...
        <div className="container">
          <div className="lg:w-[670px] mx-auto">
            <h2 className="heading text-center">
              Providing the best mdeical services in Nigeria
            </h2>
